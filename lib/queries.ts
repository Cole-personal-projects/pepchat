...
export const MESSAGE_SELECT =
  '*, profiles(username, avatar_url, display_name, username_color), replied_to:reply_to_id(id, content, user_id, profiles(username, avatar_url, display_name)), mirrored_from_thread:mirrored_from_thread_id(id, thread_root_id), reactions:message_reactions(id, message_id, user_id, emoji, created_at, profiles(username))'
